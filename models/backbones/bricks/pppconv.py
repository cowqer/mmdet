...
class PPPConv(nn.Module):  # 3*3 + 5*5
    ...
    def __init__(self, c1, c2, k, s):
        ...
        p3 = [(k+4, 0, 1, 0), (0, k+4, 0, 1), (0, 1, k+4, 0), (1, 0, 0, k+4)]
        self.pad3 = [nn.ZeroPad2d(padding=(p3[g])) for g in range(4)]
        self.cw3 = Conv(c1, c2 // 4, (1, k+4), s=s, p=0)
        self.ch3 = Conv(c1, c2 // 4, (k+4, 1), s=s, p=0)  
    ...
    def forward(self, x):
        ...
        # print(output2.shape)
        yw4 = self.cw3(self.pad3[0](x))
        yw5= self.cw3(self.pad3[1](x))
        yh4 = self.ch3(self.pad3[2](x))
        yh5 = self.ch3(self.pad3[3](x))
        # print(yw4.shape, yw5.shape, yh4.shape, yh5.shape)
        output3 = self.cat(torch.cat([yw4, yw5, yh4, yh5], dim=1))
...
if __name__ == "__main__":
    ...
    pconv = PPPConv(c1=3, c2=64, k=3, s=1)
